...
% WNIOSKI Im większy przedział argumentów funkcji tym większy błąd, wynika
% to ze względu na to że zmniejsza się liczba argumentów znanych wartości
% funkji więc interpolacja jest mniej dokładna
% interpolacji dla log10() nie ma błędu interpolacji (?)