...
x = [ 1 2 3 4 5 6 7 ];
y = [ 0.912 0.945 0.978 0.997 17.013 1.035 1.057 ];
...
a_2 = polyfit(x,y, 1),
%Otrzymany wynik jest taki sam
a_3 = polyfit(x,y,6),
% im wyższy rząd wielomianu tym większy współczynnik
% Jeśli stopień wielomianu jest większy niż rzeczywity stopień funkcji, model może starać się dostosować do szumów w danych, co może prowadzić do nierealistycznych wyników.
